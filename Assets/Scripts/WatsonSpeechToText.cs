/// <summary>
/// WatsonSpeechToText: Watson SpeechToText Service Connector
...
public class WatsonSpeechToText: MonoBehaviour
{
    ...
    [SerializeField]
    WatchedStringVariable recognizedText;
    ...
    {
        Debug.Log("WatsonServiceConnection.OnDestroy()");
        StopRecording();
        ...
        if (result != null && result.results.Length > 0)
        {
            foreach (var res in result.results)
            {
                ...
                foreach (var alt in res.alternatives)
                {
                    ...
                    // clients have either registered to receive OnChanged
                    // or will refresh in their Update()

                    recognizedText.Value = alt.transcript;
                }
